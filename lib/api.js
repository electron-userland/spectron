...
function Api(app, requireName, remoteMain) {
  this.app = app;
...
Api.prototype.addApiCommands = function (api) {
  ...
  this.addMainProcessApis(this.remote);
...
Api.prototype.loadApi = function () {
  return this.app.client.execute(function (requireName) {
    ...
    function addWebContents() {
      ...
      // required for using @electron/remote webContents
      this.remoteMain.enable(webContents);
