...
Application.prototype.start = function () {
  ...
  return self
    ...
    .then(() => self.createClient())
    .then(() => self.api.initialize())
...
Application.prototype.stop = async function () {
  if (!this.isRunning()) {
...
Application.prototype.restart = async function () {
  await this.stop();
  return this.start();
};
